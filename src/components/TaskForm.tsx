      ...
      <div className="space-y-5">
          ...
          {tags.length > 0 && (
            <div className="flex flex-wrap gap-2 mt-2">
              {tags.map((t) => (
                <span
                  key={t}
                  className="badge bg-slate-100 dark:bg-[#1c1c1c] text-slate-600 dark:text-slate-300"
                >
                  {t}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Select
            ...
            value={plannedPeriod}
            onChange={(e) => setPlannedPeriod(e.target.value as "manha" | "tarde" | "noite" | "")}
          >
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            />
            <button onClick={addSubtaskItem} className="btn-secondary px-3">
              <Plus className="h-4 w-4" />
            </button>
          </div>
          {subtasks.length > 0 && (
            <div className="space-y-1.5 mt-2">
              {subtasks.map((s, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-50 dark:bg-[#1c1c1c]/50"
                >
